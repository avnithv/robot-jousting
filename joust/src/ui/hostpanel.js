...
export class HostPanel {
  ...
  paintSettings() {
    ...
    const as = this.row(box, 'Pass shape & arm speed', 'live arms: speed, beats per pass, overlap, hold, feeds... all in arm/turn_profile.json (Turn profile panel in the studio, http://localhost:8765)');
    el('div', 'hdval fixed', as, 'profile');
